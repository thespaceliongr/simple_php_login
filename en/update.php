...
$update = "UPDATE users SET firstname='$firstname', lastname='$last', email='$email', age='$age', location='$location', website='$website' WHERE id='$pid'";
$add_member = mysql_query($update);
if (mysql_query($update, $dbc)) {
    header ("location: profile.php");
} else {
    echo "Error updating record: " . mysql_error($dbc);
}
